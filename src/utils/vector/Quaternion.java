...
public class Quaternion extends Vector implements ReadableVector4f {
	 ...
	 * (non-Javadoc)
	 *
	 * @see utils.vector.WritableVector2f#set(float, float)
	 */
	 ...
	 * (non-Javadoc)
	 *
	 * @see utils.vector.WritableVector3f#set(float, float, float)
	 */
	 ...
	 * (non-Javadoc)
	 *
	 * @see utils.vector.WritableVector4f#set(float, float, float,
	 *      float)
	 */
	...
	/* (non-Javadoc)
	 * @see utils.vector.Vector#load(java.nio.FloatBuffer)
	 */
	...
	/* (non-Javadoc)
	 * @see utils.vector.ReadableVector#store(java.nio.FloatBuffer)
	 */
